const data = `----------------------------763674504710465161187611
Content-Disposition: form-data; name="id"

123
----------------------------763674504710465161187611
...
const boundary = '----------------------------763674504710465161187611';

const parse = (multipartBuffer, boundary) => {
  let process = file => {
...
console.log(parse(data, '----------------------------763674504710465161187611'))
